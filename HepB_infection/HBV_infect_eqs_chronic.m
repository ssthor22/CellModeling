...
k_mRNAtranscript = 0.333; %1/min; 1/180; %mRNAsub transcription rate (1/s) ****
k_pmRNAtranscript = 0; %pmRNAsub transcription rate *****
...
%F(1,1) = -k_a*Vex; %Extracellular virus attach
...
F(8,1) = k_RNAtransport*pmRNAsub - k_pack*pmRNAcyt - k_degrade*pmRNAcyt; %pmRNAcyt --> packaged away at a fast rate
